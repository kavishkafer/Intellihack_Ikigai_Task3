...
def get_result(query):                  
    ...
    query_pipeline.add_component("llm", HuggingFaceTGIGenerator(model="mistralai/Mistral-7B-v0.1", token=Secret.from_token("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")))
